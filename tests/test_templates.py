...
class TestTemplateManager(unittest.TestCase):
    ...
    def test_render_documentation_success(self, mock_get_template):
        ...
        def mock_template_side_effect(template_name):
            ...
            if template_name == "test_doc_template.md":
                mock_template.render.return_value = "Rendered documentation"
            elif template_name == "default_footer.md":
                mock_template.render.return_value = (
                    "*Generated by DocGenAI using test-backend backend*"
                )
        ...
        context = {
            ...
            "model_info": {"name": "test-model", "backend": "test-backend"},
        }

        result = self.template_manager.render_documentation(context)

        # Should include documentation content and footer
        self.assertIn("Rendered documentation", result)
        self.assertIn("Generated by DocGenAI", result)
        self.assertEqual(
            mock_get_template.call_count, 2
        )  # Called for both doc and footer templates
    ...
    def test_render_documentation_template_not_found(self, mock_get_template):
        ...
        with patch.object(
            ...
            # Should include default content and footer
            self.assertIn("Default rendered content", result)
            self.assertIn("Generated by DocGenAI", result)
