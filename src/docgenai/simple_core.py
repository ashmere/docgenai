"""
Simplified Core Documentation Generator for DocGenAI

This module implements the simplified architecture using smart file selection,
intelligent chunking, and high-quality prompts to generate excellent
...
from .chunker import FileChunk, IntelligentChunker
from .file_selector import SmartFileSelector
...
class SimplifiedDocumentationGenerator:
    """
    Simplified documentation generator using smart file selection,
    ...
    def __init__(self, model: AIModel, config: Dict[str, Any]):
        ...
        self.file_selector = SmartFileSelector(config)
        self.chunker = IntelligentChunker(config, model)
        ...
        logger.info("🚀 SimplifiedDocumentationGenerator initialized")
    ...
    def generate_documentation(
        ...
        try:
            ...
            logger.info("🔍 Phase 1: Smart file selection")
...
def generate_documentation_simplified(
    codebase_path: str,
    output_dir: str = "output",
    config: Optional[Dict[str, Any]] = None,
) -> Dict[str, Any]:
    """
    Generate documentation using the simplified approach.
    ...
    # Create generator
    generator = SimplifiedDocumentationGenerator(model, config)
